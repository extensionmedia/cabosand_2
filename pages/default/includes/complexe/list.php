...
$tags = [
	[ 'hide'=>'', 'id'=>'name', 'label' => 'Complexe'],
	[ 'hide'=>'hide', 'id'=>'nbr_propriete', 'label' => 'APPART.'],
	[ 'hide'=>'hide', 'id'=>'ville', 'label' => 'VILLE']
];

$filters = [
	'Type'					=>	$ob->find('', ['order'=>'complexe_type DESC'], 'complexe_type')
];
	...
	<div class="page-head">
		...
		<div class="search d-flex space-between">
			<div class="request d-flex">
				...
				<button class="mr-5 page_search_button" data-controler="<?= $table_name ?>" data-use="v_complexe" data-column_style="v_complexe"><i class="fa fa-search"></i></button>
				...
				<?php
					...
					foreach($filters as $key=>$value){
						...
						foreach($value as $k=>$v){	
							if($key === "Type")
								$string .= '<option value="'.$v["id"].'">'. strtoupper( $v["complexe_type"] ) ."</option>";	
						}
						$string .= '</select>';
					}
				echo $string;
