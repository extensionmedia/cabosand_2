...
<div class="row page_title">
	<div class="col_6-inline icon">
		<i class="fas fa-address-card"></i> Status Propriété
	</div>
...
<?php
		$args = array(
			"column_style"		=>		"v_propriete_status",
			"sort_by"			=>		"propriete_status desc"
					 );
		echo $ob->drawTable($args,null,"v_propriete_status");
?>
