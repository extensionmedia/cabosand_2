...
<div class="row page_title">
	<div class="col_6-inline icon">
		<i class="fas fa-address-card"></i> Status Propriété (2)
	</div>
	<div class="col_6-inline actions">
		<button class="btn btn-green _add" value="<?= $table_name ?>"><i class="fas fa-plus" aria-hidden="true"></i></button>
...
<?php
		$args = array(
			"column_style"		=>		"v_propriete_status_2",
			"sort_by"			=>		"propriete_status desc"
					 );
		echo $ob->drawTable($args,null,"v_propriete_status_2");
?>
