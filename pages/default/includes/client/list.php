...
$tags = [
	...
	[ 'hide'=>'hide', 'id'=>'societe_name', 'label' => 'Société'],
...
$filters = [
	'Category'				=>	$ob->find('', ['order'=>'client_category DESC'], 'client_category'),
	'Type'					=>	$ob->find('', ['order'=>'client_type DESC'], 'client_type'),
	'Client_Status'			=>	$ob->find('', ['order'=>'client_status DESC'], 'client_status'),
];
	...
	<div class="page-head">
		...
		<div class="search d-flex space-between">
			<div class="request d-flex">
				...
				<button class="mr-5 page_search_button" data-controler="<?= $table_name ?>" data-use="v_client" data-column_style="v_client"><i class="fa fa-search"></i></button>
