...
<div class="panel">
	...
	<div class="panel-content">
		...
		<div class="menu_form">
			...
			<h3 style="margin-left: 6px">Client Status</h3>
			<input type="hidden" value="<?= $data["id"]  ?>" id="id">
			
			<div class="row" style="margin-bottom: 20px">
				<div class="col_12-inline">
					<input type="text" placeholder="Client Status" id="client_status" value="<?= $data["client_status"] ?>">
				</div>		
			...
			<div class="row" style="margin-bottom: 20px">
				<div class="col_6-inline">
					<div class="" style="position: relative; width: 125px">
						<div class="on_off <?= ($data["is_default"] == 1)? "on" : "off" ?>" id="client__status"></div>
