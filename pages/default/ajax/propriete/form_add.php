...
<div class="row page_title">
	...
	<div class="col_6-inline actions <?= strtolower($return_page) ?>">
		...
		<button class="btn btn-default close_form" value="<?= $return_page ?>"><i class="fas fa-times"></i></button>
	</div>
</div>
<hr>
...
<div class="panel">
	<div class="panel-header" style="padding: 0px">
		<div class="panel-header-tab ">
			...
			<a href="" class="refresh_location"><i class="fas fa-key"></i> Contrat</a>
			...
			<div class="propriete_form">
				...
				<div class="row" style="margin-bottom: 20px">
					...
					<div class="col_4-inline">
						...
						<input type="text" placeholder="Code" data-code="-1" id="propriete_code" value="" style="background-color: #ededed; font-weight: bold">
					</div>				
				...
				<div class="row" style="margin-bottom: 20px">
					...
					<div class="col_3-inline">
						...
						<input type="number" placeholder="0" id="propriete_numero" value="0">
					</div>
					<div class="col_3-inline">
				...
				<div class="row" style="margin-bottom: 20px">
					<div class="col_3-inline">
						...
						<input type="number" placeholder="0" id="propriete_surface" value="0">
					</div>				
					<div class="col_3-inline">
						<label for="propriete_chambre">Chambre </label>
						<input type="number" placeholder="0" id="propriete_chambre" value="2">
					</div>
					<div class="col_3-inline">
						<label for="propriete_max_person">Persone </label>
						<input type="number" placeholder="0" id="propriete_max_person" value="6">
					</div>
				</div>
						...
						<div class="row" style="margin-bottom: 20px;">
							<div class="col_12">
								<label for="propriete_isForSell">
									<input type="checkbox" id="propriete_isForSell"> Disponible pour la vente
								</label>					
							</div>
				...
				<div class="row" style="margin-bottom: 20px;">
					<div class="col_12">
						<textarea id="propriete_notes" style="max-width: 100%; height: 150px"></textarea>					
					</div>
				</div>
		...
		<div class="tab-content" style="display: none">
			<div class="location_form">
				...
				<div class="location_form_content">
					...
					echo $propriete_proprietaire_location->drawTable("", array("conditions" => array("id_propriete=" => 0 )), "v_propriete_proprietaire_location" );
					?>				
				</div>
		...
		<div class="tab-content" style="display: none" >
			<div class="row upload">
				...
				<div class="col_8-inline" style="text-align: right; padding-top: 10px">
					...
					<input type="file" id="upload_file_propriete" data="<?= substr($formToken,0,8); ?>" class="" name="image" capture style="position: absolute; z-index: 9999; top: 0; left: 0; background-color: aqua; padding: 10px 0; opacity: 0">
					</button>	
					<button class="btn btn-blue show_files propriete" value="<?= substr($formToken,0,8); ?>"> Actualiser </button>					
				</div>
