...
if(file_exists($_SESSION['CORE'].$table_name.".php")){
	...
	if( isset($_POST["data"]["columns"]["id"]) ){
		...
		$ob->saveActivity("fr",$_SESSION["CABOSANDE-MANAGER"]["USER"]["id"],array("Person","0"),$lastID);
	}else{
		...
		$lastID = $ob->getLastID();
		$ob->saveActivity("fr",$_SESSION["CABOSANDE-MANAGER"]["USER"]["id"],array("Person","1"),$lastID);
	}
