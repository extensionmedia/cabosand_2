		...
		<div class="menu_form">
			...
			<div class="row" style="margin-bottom: 20px">
				<div class="col_9">
					...
					<input type="text" placeholder="Nom de la société" id="raison_social" value="">
				</div>
				<div class="col_3">
					...
					<select id="forme_juridique">
						<option selected value="-1"></option>
							...
							?>	
						<option <?= ($v["is_default"]==1)? "selected":"" ?> value="<?= $v["id"] ?>"> <?= "[ " . $v["ABR"] . " ] " . $v["forme_juridique"] ?> </option>
							<?php } ?>
					</select>
			...
			<div class="row" style="margin-bottom: 20px">
				<div class="col_12">
					...
					<input type="text" placeholder="Slogon de la société" id="slogon" value="">
				</div>
			</div>
			<div class="row" style="margin-bottom: 20px">
				<div class="col_2">
					<label for="capital">Capital </label>
					<input type="number" placeholder="10 000,00" id="capital" value="0.00">
				</div>
			</div>
			<div class="row" style="margin-bottom: 20px; border-bottom: 1px solid rgba(197,197,197,1.00)">
				<div class="col_12-inline">
			...
			<div class="row" style="margin-bottom: 20px">
				<div class="col_12">
					...
					<input type="text" placeholder="Adresse de la société" id="adresse" value="">
				</div>			
			...
			<div class="row" style="margin-bottom: 20px">
				<div class="col_6-inline">
					...
					<input type="text" placeholder="+212661098984" id="telephone_1" value="">
				</div>			
				<div class="col_6-inline">
					<label for="telephone_2">Téléphone (2) </label>
					<input type="text" placeholder="+212661098984" id="telephone_2" value="">
				</div>
			</div>
			<div class="row" style="margin-bottom: 20px">
				<div class="col_6-inline">
					<label for="fax_1">Fax (1) </label>
					<input type="text" placeholder="+212539565251" id="fax_1" value="">
				</div>			
				<div class="col_6-inline">
					<label for="fax_2">Fax (2) </label>
					<input type="text" placeholder="+212539565251" id="fax_2" value="">
				</div>
			</div>
			<div class="row" style="margin-bottom: 20px">
				<div class="col_6-inline">
					<label for="email">E-Mail </label>
					<input type="text" placeholder="exemple@email.com" id="email" value="">
				</div>			
				<div class="col_6-inline">
					<label for="site_internet">Site Web </label>
					<input type="text" placeholder="http://" id="site_internet" value="">
				</div>
			</div>
			<div class="row" style="margin-bottom: 20px; border-bottom: 1px solid rgba(197,197,197,1.00)">
				<div class="col_12-inline">
			...
			<div class="row" style="margin-bottom: 20px">
				<div class="col_6-inline">
					...
					<input type="text" placeholder="123456" id="ice" value="">
				</div>			
				<div class="col_6-inline">
					<label for="registre_commerce">Registre Commerce </label>
					<input type="text" placeholder="123456" id="registre_commerce" value="">
				</div>
			</div>
			<div class="row" style="margin-bottom: 20px">
				<div class="col_4-inline">
					<label for="patente">Patente </label>
					<input type="text" placeholder="123456" id="patente" value="">
				</div>			
				<div class="col_4-inline">
					<label for="cnss">CNSS </label>
					<input type="text" placeholder="123456" id="cnss" value="">
				</div>
				<div class="col_4-inline">
					<label for="identification_fiscale">Identification Fiscale </label>
					<input type="text" placeholder="123456" id="identification_fiscale" value="">
				</div>
			</div>
			...
			<div class="row" style="margin-bottom: 20px">
				...
				<div class="col_12-inline">
					<div class="on_off off" id="is_default"> </div>
				</div>	
			</div>					
			<div class="row" style="margin-bottom: 20px">
			...
			<div class="row" style="margin-bottom: 20px;">
				<div class="col_12">
					<textarea id="notes" style="max-width: 100%; height: 150px"></textarea>					
				</div>
