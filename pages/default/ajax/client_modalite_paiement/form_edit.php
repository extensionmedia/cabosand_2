...
$formToken=uniqid();
$return_page = "Client_Modalite_Paiement";
?>
		...
		<div class="menu_form">
			...
			<div class="row" style="margin-bottom: 20px">
				<div class="col_12-inline">
					<input type="text" placeholder="Modalité Paiement" id="client_modalite_paiement" value="<?= $data["client_modalite_paiement"] ?>">
				</div>		
			...
			<div class="row" style="margin-bottom: 20px">
				<div class="col_6-inline">
					<div class="" style="position: relative; width: 125px">
						<div class="on_off <?= ($data["is_default"] == 1)? "on" : "off" ?>" id="client_modalite_paiement_status"></div>
