...
if(file_exists($_SESSION['CORE'].$table_name.".php")){
	...
	$data = array(
		...
		"name"				=>	addslashes($_POST["data"]["columns"]["name"]),
		"solde_initial"		=>	$_POST["data"]["columns"]["solde_initial"],
		"solde_minimum"		=>	$_POST["data"]["columns"]["solde_minimum"],
		"notes"				=>	addslashes($_POST["data"]["columns"]["notes"]),
		"status"			=>	$_POST["data"]["columns"]["caisse_status"]
	);
