...
$formToken=uniqid();
$return_page = "Propriete_Category";
?>
...
<div class="panel">
	...
	<div class="panel-content">
		...
		<div class="menu_form">
			...
			<h3 style="margin-left: 6px">Propriété Catégorie</h3>
			<input type="hidden" value="<?= $data["id"]  ?>" id="id">
			
			<div class="row" style="margin-bottom: 20px">
				<div class="col_12-inline">
					<input type="text" placeholder="Complexe Type" id="propriete_category" value="<?= $data["propriete_category"] ?>">
				</div>		
			...
			<div class="row" style="margin-bottom: 20px">
				<div class="col_6-inline">
					<div class="" style="position: relative; width: 125px">
						<div class="on_off <?= ($data["is_default"] == 1)? "on" : "off" ?>" id="propriete_category_status"></div>
